...
NSString * const JYWineCellAddNotification    = @"JYWineCellAddNotification";
NSString * const JYWineCellRemoveNotification = @"JYWineCellRemoveNotification";
...
- (IBAction)addWine:(id)sender
{
    ...
    // 点击添加按钮, 发送通知
    [[NSNotificationCenter defaultCenter] postNotificationName: JYWineCellAddNotification object:self];
}
...
- (IBAction)removeWine:(id)sender
{
    ...
    // 点击移除按钮, 发送通知
    [[NSNotificationCenter defaultCenter] postNotificationName:JYWineCellRemoveNotification object:self];
}
